...
1. 已用 2024 专业组线和 2023 旧文理科院校线预测 2025 实际投档线；
2. 已新增 `npm run test:week10` 和 `npm run verify:week10`；
3. 已补充 README 作品集说明；
4. 已新增 `docs/week10-backtest-wrap-up.md`。

后续再考虑 PWA、分享链接、多方案对比、服务端方案保存和扩省功能。
