...
当前版本使用近三年历史投档位次。2024、2025 优先使用改革后同院校专业组口径；同组历史缺失时，用同院校、同科类、同选科要求的相近专业组补充并标注。2023 使用改革前院校级文理科口径，理科映射物理类，文科映射历史类，再选科目按不限处理：
...
当只有一年历史最低位次时，仍计算参考位次，但标为低置信度。近三年不完整、改革后同组历史不足两年、使用同院校专业组补充参考或没有历史最低位次时，推荐项会暴露低置信度原因。`historicalRanks` 中的 2023 行会标注“旧文理科院校线”，不视为专业组投档线。
