...
import { getCandidateCollegeGroups } from "@/lib/queries/candidate-groups";
...
export async function POST(request: Request) {
  ...
  let result: Awaited<ReturnType<typeof getCandidateCollegeGroups>>;

  try {
    result = await getCandidateCollegeGroups(parsed.data.profile, {
